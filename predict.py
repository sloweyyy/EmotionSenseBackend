...
pkl_filename_with_hog = "svm_model_with_hog.pkl"
pkl_filename_without_hog = "svm_model_without_hog.pkl"

with open(pkl_filename_with_hog, 'rb') as f_in:
    model_with_hog = pickle.load(f_in)

with open(pkl_filename_without_hog, 'rb') as f_in:
    model_without_hog = pickle.load(f_in)
